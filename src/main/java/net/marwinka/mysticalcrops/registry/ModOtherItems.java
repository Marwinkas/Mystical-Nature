...
import static net.marwinka.mysticalcrops.MysticalCrops.ITEMGROUPOTHER;
...
public class ModOtherItems {
    ...
    public static Crop register(Crop crop) {
        if (crop.isEnabled()) crops.add(crop);
        return crop;
    }
    ...
    public static void registerItems() {
        crops.forEach(c -> {
            ...
            Item defaultEssence;
            defaultEssence = new MysticalEssenceItem(c, p -> p.group(ITEMGROUPOTHER));
            c.setEssence(() -> defaultEssence);
            Registry.register(Registry.ITEM, new ModIdentifier(c.getId() + "_essence"), defaultEssence);

            Item defaultfruit;
            defaultfruit = new MysticalFruitItem(c, p -> p.group(ITEMGROUPOTHER));
            ...
            defaultSeeds = new MysticalSeedItem(c, p -> p.group(ITEMGROUPOTHER));
