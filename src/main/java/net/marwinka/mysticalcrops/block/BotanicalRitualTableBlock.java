...
import net.marwinka.mysticalcrops.entity.BotanicalRitualTableEntity;
...
public class BotanicalRitualTableBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public BotanicalRitualTableBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntityRegister.BOTANICAL_RITUAL_TABLE, BotanicalRitualTableEntity::tick);
    }
}