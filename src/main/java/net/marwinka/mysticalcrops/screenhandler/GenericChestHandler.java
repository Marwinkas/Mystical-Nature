...
public class GenericChestHandler extends SyncedGuiDescription {
    Inventory inventory;

    public GenericChestHandler(ScreenHandlerType<?> type, ChestTypes chestType, int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
