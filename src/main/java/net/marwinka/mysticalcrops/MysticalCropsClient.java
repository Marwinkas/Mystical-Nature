...
public class MysticalCropsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.AIR.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.WATER.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.NETHER.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.AMETHYST.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.SAND.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.GRAVEL.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.SNOW.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.DYE.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.END.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.ENDER.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.CLAY.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.NATURE.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.SOUL.getCrop(), RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(new_system_seed.PRISMARINE.getCrop(), RenderLayer.getCutout());
