...
public class Items {
    ...
    public static final Item WOOD_SEEDS = register(new Tier2(Crops.WOOD_CROP, new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "wood_seeds");
    ...
    public static final Item STAR_SEEDS = register(new Tier5(Crops.STAR_CROP, new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "star_seeds");
    public static final Item WITHER_SEEDS = register(new Tier5(Crops.WITHER_CROP, new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "wither_seeds");
    ...
    public static final Item WOOD_FRUIT = register(new ItemTier2(new FabricItemSettings().group(ModItemGroup.ITEMGROUP).food(new FoodComponent.Builder().hunger(3).saturationModifier(3).build())), "wood_fruit");
    ...
    public static final Item STAR_FRUIT = register(new ItemTier5(new FabricItemSettings().group(ModItemGroup.ITEMGROUP).food(new FoodComponent.Builder().hunger(3).saturationModifier(3).build())), "star_fruit");
    public static final Item WITHER_FRUIT = register(new ItemTier5(new FabricItemSettings().group(ModItemGroup.ITEMGROUP).food(new FoodComponent.Builder().hunger(3).saturationModifier(3).build())), "wither_fruit");

    public static final Item CRAFT_SEEDS = register(new ItemTier0(new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "craft_seeds");
    public static final Item CRAFT_SEEDS_TIER_2 = register(new ItemTier2(new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "craft_seeds_tier_2");
    public static final Item CRAFT_SEEDS_TIER_3 = register(new ItemTier3(new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "craft_seeds_tier_3");
    public static final Item CRAFT_SEEDS_TIER_4 = register(new ItemTier4(new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "craft_seeds_tier_4");
    public static final Item CRAFT_SEEDS_TIER_5 = register(new ItemTier5(new FabricItemSettings().group(ModItemGroup.ITEMGROUP)), "craft_seeds_tier_5");
    ...
    public static final Item ULTRA_CRYSTAL = register(new CrystalUltra(CrystalULTRAdurability.ULTRA_CRYSTALS,0,0,new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "ultra_crystal");
    public static final Item ULTIMATE_CRYSTAL = register(new CrystalUltimate(CrystalULTIMATEdurability.ULTIMATE_CRYSTALS,0,0,new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "ultimate_crystal");
    public static final Item INFINITY_CRYSTAL = register(new CrystalInfinity(new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "infinity_crystal");
    public static final Item IRON_KNIFE = register(new Knife(ToolMaterials.IRON,0,-3,new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "iron_knife");
    public static final Item DIAMOND_KNIFE = register(new Knife(ToolMaterials.DIAMOND,0,-3,new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "diamond_knife");
    public static final Item NETHERITE_KNIFE = register(new Knife(ToolMaterials.NETHERITE,0,-3,new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "netherite_knife");
