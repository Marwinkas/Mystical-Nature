...
public class Items {
    ...
    public static final Item ECHO_SEEDS = register(new Tier4(Crops.ECHO_CROP, new FabricItemSettings().group(ModItemGroupMinecraft.ITEMGROUP)), "echo_seeds");
    ...
    public static final Item ECHO_FRUIT = register(new ItemTier4(new FabricItemSettings().group(ModItemGroupMinecraft.ITEMGROUP).food(new FoodComponent.Builder().hunger(3).saturationModifier(3).build())), "echo_fruit");
