...
public class Items {
    ...
    public static final Item WITHER_SOUL = register("wither_soul");
    ...
    public static final Item INFINITY_CRYSTAL = register(new CrystalInfinity(CrystalINFINITYdurability.INFINITY_CRYSTALS,0,0,new FabricItemSettings().group(ModItemGroup.ITEMGROUP).maxCount(1)), "infinity_crystal");
