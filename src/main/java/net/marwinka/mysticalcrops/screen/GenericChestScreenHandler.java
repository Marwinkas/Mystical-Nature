...
public class GenericChestScreenHandler extends SyncedGuiDescription {
    Inventory inventory;

    public GenericChestScreenHandler(ScreenHandlerType<?> type, ChestTypes chestType, int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
