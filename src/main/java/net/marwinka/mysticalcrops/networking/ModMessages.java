...
import net.marwinka.mysticalcrops.networking.packet.ExampleC2SPacket;
...
public class ModMessages {
    ...
    public static final Identifier EXAMPLE_ID = new Identifier(MysticalCrops.MOD_ID, "example");
