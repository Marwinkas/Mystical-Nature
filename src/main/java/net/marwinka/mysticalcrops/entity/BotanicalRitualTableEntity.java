...
import net.marwinka.mysticalcrops.block.BotanicalRitualTableBlock;
...
public class BotanicalRitualTableEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public BotanicalRitualTableEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntityRegister.BOTANICAL_RITUAL_TABLE, pos, state);
