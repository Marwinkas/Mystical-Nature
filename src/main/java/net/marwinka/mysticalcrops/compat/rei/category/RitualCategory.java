...
public class RitualCategory implements DisplayCategory<RitualDisplay> {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.RITUAL_TABLE.asItem());
    }

    @Override
    public Text getTitle() {
        return new TranslatableText(ModBlocks.RITUAL_TABLE.getTranslationKey());
    }
    ...
    public CategoryIdentifier<? extends RitualDisplay> getCategoryIdentifier() {
        return REICategories.RITUAL_CATEGORY;
    }
    ...
    public List<Widget> setupDisplay(RitualDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createArrow(new Point(startPoint.x + 30, startPoint.y - 7)).animationDurationTicks(400));
        ...
        Text ratioText = new TranslatableText("rei.text.ad_astra.seconds", 600 / 20);
